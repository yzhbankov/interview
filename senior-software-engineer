...
- [ ] Explain sliding window out loud
- [ ] List edge cases
...
- [ ] Design **Metrics / Logging Pipeline**
- [ ] Define message queue (Kafka-like)
- [ ] Describe consumers
- [ ] Handle backpressure
...
- [ ] Prepare default architecture template

---

### Thursday — Behavioral
- [ ] Finalize "Tell me about yourself"
